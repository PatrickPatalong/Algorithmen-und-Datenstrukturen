...
if __name__ == "__main__":
    filenames = ["test.txt","casanova-erinnerungen-band-2.txt", "die-drei-musketiere.txt", "helmholtz-naturwissenschaften.txt"]
    for filename in filenames:
        ...
        print(f"{average_depth_dynamic} dynamic und {average_depth_random} random")
        average_depth_random = average_depth_random / word_count
        average_depth_dynamic = average_depth_dynamic / word_count

        print(f"""
{filename}:
Random Treap hat mittlere Tiefe {average_depth_random} und mittlere Zugriffszeit {average_accesstime_random}.
Dynamic Treap hat mittlere Tiefe {average_depth_dynamic} und mittlere Zugriffszeit {average_accesstime_dynamic}.
""")
